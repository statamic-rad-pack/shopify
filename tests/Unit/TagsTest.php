...
window.shopifyConfig = { url: 'abcd', token: '1234', apiVersion: '2025-04', currency: '£' };
</script>"),
    ...
    {
        // NOTE: if you are looking at this the JSON isnt quite the response from Shopify
        // but we dont need that for testing the concept
